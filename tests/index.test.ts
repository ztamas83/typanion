...
const VALIDATION_TESTS: {
  ...
  },
  {
    validator: () =>
      t.isOneOf([
        t.isObject({ foo: t.isString() }, { extra: t.isUnknown() }),
        t.isObject({ bar: t.isString() }, { extra: t.isUnknown() }),
      ]),
    tests: [
      [{ foo: `foo` }, true],
      [{ bar: `bar` }, true],
  ...
  {
    validator: () =>
      t.isRecord(t.isNumber(), {
        keys: t.cascade(t.isString(), [t.isUUID4()]),
      }),
    tests: [
      [{}, true],
  ...
  for (const { validator, tests } of VALIDATION_TESTS) {
    describe(`Validation for ${validator.toString()}`, () => {
      ...
      for (const [value, expectation] of tests) {
        const what = expectation ? `allow` : `disallow`;
...
const ERROR_TESTS: {
  ...
  {
    validator: () => t.isString(),
    tests: [[42, [`.: Expected a string (got 42)`]]],
  },
  {
    validator: () => t.isObject({ foo: t.isString() }),
    tests: [
      ...
      [
        { foo: ``, bar: `` },
        [`.bar: Extraneous property (got an empty string)`],
      ],
      [
        { foo: ``, [`foo bar`]: `` },
        [`.["foo bar"]: Extraneous property (got an empty string)`],
      ],
    ],
  },
  {
    ...
    tests: [
      [
        JSON.parse(`{"constructor": "foo"}`),
        [`.constructor: Unsafe property name`],
      ],
      [
        JSON.parse(`{"__proto__": "foo"}`),
        [`.__proto__: Unsafe property name`],
      ],
    ],
  },
  {
  ...
  {
    validator: () => t.isEnum([`foo`, `bar`]),
    tests: [[`baz`, [`.: Expected one of "foo" or "bar" (got "baz")`]]],
  },
  {
    validator: () => t.isEnum([5, 10, 15]),
    tests: [[42, [`.: Expected one of 5, 10, or 15 (got 42)`]]],
  },
  {
    validator: () => t.isEnum({ FOO: `foo`, BAR: `bar` }),
    tests: [[`baz`, [`.: Expected one of "foo" or "bar" (got "baz")`]]],
  ...
  },
  {
    ...
    tests: [
      [
        42,
        [`.#1: Expected a string (got 42)`, `.#2: Expected a boolean (got 42)`],
      ],
      [true, []],
    ],
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasForbiddenKeys([`foo`, `bar`]),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Forbidden property "foo"`]],
      [
        { foo: undefined, bar: null },
        [`.: Forbidden properties "foo" and "bar"`],
      ],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasForbiddenKeys([`foo`, `bar`], { missingIf: "missing" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Forbidden property "foo"`]],
      [
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasForbiddenKeys([`foo`, `bar`], { missingIf: "undefined" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Forbidden property "foo"`]],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasForbiddenKeys([`foo`, `bar`], { missingIf: "nil" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Forbidden property "foo"`]],
      [{ foo: undefined, bar: null }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasForbiddenKeys([`foo`, `bar`], { missingIf: "falsy" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Forbidden property "foo"`]],
      [{ foo: undefined, bar: null }, []],
  ...
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [t.hasRequiredKeys([`foo`, `bar`])]),
    tests: [
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasRequiredKeys([`foo`, `bar`], { missingIf: "missing" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Missing required property "bar"`]],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasRequiredKeys([`foo`, `bar`], { missingIf: "undefined" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Missing required property "bar"`]],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasRequiredKeys([`foo`, `bar`], { missingIf: "nil" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Missing required property "bar"`]],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasRequiredKeys([`foo`, `bar`], { missingIf: "falsy" }),
      ]),
    tests: [
      [{ foo: 42 }, [`.: Missing required property "bar"`]],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasAtLeastOneKey([`foo`, `bar`], { missingIf: "missing" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasAtLeastOneKey([`foo`, `bar`], { missingIf: "undefined" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasAtLeastOneKey([`foo`, `bar`], { missingIf: "nil" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ foo: 42, bar: 42 }, []],
      [
        { foo: undefined, bar: null },
        [`.: Missing at least one property from "foo" or "bar"`],
      ],
      [{ foo: false, bar: null }, []],
      [{ foo: false, bar: 0 }, []],
      [{ baz: 42 }, [`.: Missing at least one property from "foo" or "bar"`]],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasAtLeastOneKey([`foo`, `bar`], { missingIf: "falsy" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ foo: 42, bar: 42 }, []],
  ...
  },
  {
    ...
    tests: [
      ...
      [
        { foo: undefined, bar: null },
        [`.: Mutually exclusive properties "foo" and "bar"`],
      ],
      [
        { foo: false, bar: null },
        [`.: Mutually exclusive properties "foo" and "bar"`],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasMutuallyExclusiveKeys([`foo`, `bar`], { missingIf: "missing" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasMutuallyExclusiveKeys([`foo`, `bar`], { missingIf: "undefined" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasMutuallyExclusiveKeys([`foo`, `bar`], { missingIf: "nil" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasMutuallyExclusiveKeys([`foo`, `bar`], { missingIf: "falsy" }),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ bar: 42 }, []],
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasKeyRelationship(`foo`, t.KeyRelationship.Forbids, [`bar`, `baz`]),
      ]),
    tests: [
      [{ foo: 42 }, []],
      [{ bar: 42 }, []],
      [
        { foo: 42, bar: 42 },
        [`.: Property "foo" forbids using property "bar"`],
      ],
      [
        { foo: 42, bar: 42, baz: 42 },
        [`.: Property "foo" forbids using properties "bar" or "baz"`],
      ],
      [{ foo: 42, qux: 42 }, []],
    ],
  },
  {
    ...
    tests: [
      ...
      [
        { foo: 42, bar: false, baz: 42 },
        [`.: Property "foo" forbids using property "baz"`],
      ],
      [{ foo: 42, qux: 42 }, []],
    ],
  },
  ...
  },
  {
    validator: () =>
      t.cascade(t.isRecord(t.isUnknown()), [
        t.hasKeyRelationship(`foo`, t.KeyRelationship.Requires, [`bar`, `baz`]),
      ]),
    tests: [
      [
        { foo: 42 },
        [`.: Property "foo" requires using properties "bar" and "baz"`],
      ],
      [{ bar: 42 }, []],
      [
        { foo: 42, bar: 42 },
        [`.: Property "foo" requires using property "baz"`],
      ],
      [{ foo: 42, bar: 42, baz: 42 }, []],
      [
        { foo: 42, qux: 42 },
...
for (const { validator, tests } of ERROR_TESTS) {
  describe(`Errors for ${validator.toString()}`, () => {
    ...
    for (const [value, expectations] of tests) {
      const what = expectations.length !== 1 ? `errors` : `error`;
...
const COERCION_TESTS: {
  ...
  },
  {
    ...
    tests: [
      ...
      [
        { foo: `123456789`.repeat(5) },
        [
          `.foo: Received a number that can't be safely represented by the runtime (${`123456789`.repeat(
            5
          )})`,
        ],
      ],
      [
        { foo: `0.123456789123456789123456789` },
        [
          `.foo: Received a number that can't be safely represented by the runtime (0.123456789123456789123456789)`,
        ],
      ],
    ],
  },
  {
    ...
    tests: [
      ...
      [
        { foo: `2024-06-27T07:28:46.215Z` },
        [],
        { foo: new Date(`2024-06-27T07:28:46.215Z`) },
      ],

      [
        { foo: `2024-06-27T07:28:46Z` },
        [],
        { foo: new Date(`2024-06-27T07:28:46Z`) },
      ],

      [
        { foo: `42.42` },
        [
          `.foo: Received a timestamp that can't be safely represented by the runtime (42.42)`,
        ],
      ],
      [{ foo: `hello` }, [`.foo: Expected a date (got \"hello\")`]],
      [
        { foo: `2024-06-27T07:28:46.1000Z` },
        [`.foo: Expected a date (got \"2024-06-27T07:28:46.1000Z\")`],
      ],
      [
        { foo: `2024-06-27T07:28:46.12Z` },
        [`.foo: Expected a date (got \"2024-06-27T07:28:46.12Z\")`],
      ],
    ],
  },
  {
  ...
  {
    validator: () =>
      t.isObject({ foo: t.isArray(t.isBoolean(), { delimiter: /,/ }) }),
    tests: [[{ foo: `true` }, [], { foo: [true] }]],
  },
  {
    validator: () =>
      t.isObject({ foo: t.isArray(t.isBoolean(), { delimiter: /,/ }) }),
    tests: [[{ foo: `true,false` }, [], { foo: [true, false] }]],
  },
  {
  ...
  {
    validator: () =>
      t.isObject({ foo: t.isSet(t.isBoolean(), { delimiter: /,/ }) }),
    tests: [
      [{ foo: `true,false` }, [], { foo: new Set([true, false]) }],
  ...
  {
    validator: () => t.isTuple([t.isString(), t.isNumber(), t.isBoolean()]),
    tests: [[[`hello`, `42`, `true`], [], [`hello`, 42, true]]],
  },
  {
    validator: () =>
      t.isObject({
        foo: t.isTuple([t.isString(), t.isNumber(), t.isBoolean()], {
          delimiter: /,/,
        }),
      }),
    tests: [[{ foo: `hello,42,true` }, [], { foo: [`hello`, 42, true] }]],
  },
  {
  ...
  },
  {
    ...
    tests: [
      [
        { val: { foo: `true`, bar: `hello` } },
        [],
        { val: { foo: true, bar: `hello` } },
      ],
      [
        { val: { foo: `true`, bar: `world` } },
        [],
        { val: { foo: `true`, bar: `world` } },
      ],
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      [
        [[`val`, 42, 12]],
        [`.[0]: Expected to have a length of exactly 2 elements (got 3)`],
      ],
    ],
  },
  {
  ...
  for (const { validator, tests } of COERCION_TESTS) {
    describe(`Coercions for ${validator.toString()}`, () => {
      ...
      for (const [value, errorExpectations, coercionExpectation] of tests) {
        const what =
          errorExpectations.length > 0 ? `Doesn't coerce` : `Coerces`;
